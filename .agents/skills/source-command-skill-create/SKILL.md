...
リポジトリのgit履歴を分析してコーディングパターンを抽出し、チームの慣習をCodexに教えるSKILL.mdファイルを生成する。
...
3. **SKILL.mdを生成** - 有効なCodexスキルファイルを作成
...
*[Everything Codex](https://github.com/affaan-m/everything-Codex)の一部*
